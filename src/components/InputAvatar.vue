<template>
    <img v-if="selected && preview" :src="preview" class="min-w-36 h-36 rounded-full overflow-hidden object-cover" alt="avatar">
    <label v-else for="inputAvatar" class="min-w-36 h-36 rounded-full overflow-hidden bg-component-bg flex justify-center items-center">
        <div>
